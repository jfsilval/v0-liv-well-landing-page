  ...
  return (
    <nav
      className={cn(
        ...
        isScrolled
          ? "bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10 backdrop-blur-md shadow-md"
          : "bg-gradient-to-r from-primary/5 via-secondary/5 to-accent/5 backdrop-blur-sm",
      )}
    >
